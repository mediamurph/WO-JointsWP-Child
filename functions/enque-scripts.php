...
add_filter( 'style_loader_tag', 'jointswp_child_remove_type_attr', 10, 2 );
add_filter( 'script_loader_tag', 'jointswp_child_remove_type_attr', 10, 2 );



function jointswp_child_remove_type_attr($tag, $handle) {
